  ...
  return user ? (
    ...
    >
      <div className="position-relative">
        <div className="position-fixed h-100 w-inherit">
          <div className="d-flex flex-column px-xl-3 px-1 justify-content-between h-100">
            ...
            <Link className="hover rounded-pill btn my-3 p-2" to="/logout">
