    ...
    <div className="display">
      ...
      <div className="border-top">
        ...
        <div className="d-flex flex-column flex-sm-row">
          <div className="d-flex col-12 col-sm-6">
            <div className="col-4">
              <label className="color my-3 mx-auto rounded-circle btn filter blue">
                <input
                  onChange={(e) =>
            ...
            <div className="col-4">
              <label className="color my-3 mx-auto rounded-circle btn filter green">
                <input
                  onChange={(e) =>
                    handleChange(theme, e.currentTarget.value, font)
                  }
            ...
            <div className="col-4">
              <label className="color my-3 mx-auto rounded-circle btn filter yellow">
                <input
                  onChange={(e) =>
                    handleChange(theme, e.currentTarget.value, font)
                  }
          ...
          <div className="d-flex col-12 col-sm-6">
            <div className="col-4">
              <label className="color my-3 mx-auto rounded-circle btn filter purple">
                <input
                  onChange={(e) =>
                    handleChange(theme, e.currentTarget.value, font)
                  }
            ...
            <div className="col-4">
              <label className="color my-3 mx-auto rounded-circle btn filter pink">
                <input
                  onChange={(e) =>
                    handleChange(theme, e.currentTarget.value, font)
                  }
            ...
            <div className="col-4">
              <label className="color my-3 mx-auto rounded-circle btn filter orange">
                <input
                  onChange={(e) =>
                    handleChange(theme, e.currentTarget.value, font)
                  }
      ...
      <div className="border-top">
        ...
        <div className="d-flex flex-column flex-sm-row">
          ...
          <div className="col-sm-4 px-3 py-2 col-12">
            <label className="theme pointer dim rounded">
              <input
                onChange={(e) =>
                  handleChange(e.currentTarget.value, color, font)
                }
